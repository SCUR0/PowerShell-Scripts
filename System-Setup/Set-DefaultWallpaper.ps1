...
icacls $env:windir\Web\Wallpaper\Windows\img0.jpg /Grant 'Administrator:(F)'
icacls $env:windir\Web\4K\Wallpaper\Windows\*.* /Grant 'Administrator:(F)'
...
Copy-Item $ScriptRoot\images\img0.jpg $env:windir\Web\Wallpaper\Windows -Force
#Copy alternative resolutions
Copy-Item $ScriptRoot\images\4K\*.* $env:windir\Web\4K\Wallpaper\Windows -Force
